...
public class Principal {
	...
	public static void main(String[] args) {
		...
		ticketek.registrarSede("Estadio mini 1", "calle 4", 500, asientosPorFilaMiniestadio, 10, 15000.0,
				sectores_teatro, capacidad_miniestadio, porcentajeAdicionalTeatro);
		ticketek.registrarSede("Mini Arena Norte", "pasaje 5", 500, asientosPorFilaMiniestadio, 12, 30000.0,
				sectores_teatro, capacidad_miniestadio, porcentajeAdicionalTeatro);
		ticketek.registrarSede("Microestadio Sur", "pje. 10", 500, asientosPorFilaMiniestadio, 20, 20000.0,
				sectores_teatro, capacidad_miniestadio, porcentajeAdicionalTeatro);
		...
		List<IEntrada> entradasConejo = ticketek.venderEntrada("El Rey Leon", "29/07/25",
		...
		List<IEntrada> entradasAlcides = ticketek.venderEntrada("Coldplay en vivo", "31/07/25", "alcides@violeta.com",
				"1234", 10);
		...
		List<IEntrada> todasLasEntradasAlcides = ticketek.listarTodasLasEntradasDelUsuario("alcides@violeta.com",
				"1234");
