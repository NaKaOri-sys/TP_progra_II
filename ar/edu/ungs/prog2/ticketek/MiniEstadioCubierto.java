...
public class MiniEstadioCubierto extends Sede {
	...
	/**
	 * Función privada que se encarga de inicializar los sectores, en caso
	 * de que los parametros no tengan un sentido lógico o no correspondan se lanzara IllegalArgumentException
	 * @param tipoSectores
