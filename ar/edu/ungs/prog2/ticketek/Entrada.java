...
public class Entrada implements IEntrada {
    ...
    public Entrada(String codigo,  Espectaculo espectaculo, Fecha fecha, Sede sede, String ubicacion, String emailComprador) {
        this.codigo = codigo;
    ...
    public Entrada(String codigo, Espectaculo espectaculo, Fecha fecha, Sede sede, String sector, int fila, int asiento, String emailComprador) {
        this.codigo = codigo;
        this.espectaculo = espectaculo;
        this.fecha = fecha;
        this.sede = sede;
